...
function createDebugChannel(responseHeaders) {
    let requestId;
    if (responseHeaders) {
        requestId = responseHeaders.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$app$2d$router$2d$headers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_REQUEST_ID_HEADER"]) ?? undefined;
        if (!requestId) {
            throw Object.defineProperty(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$shared$2f$lib$2f$invariant$2d$error$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["InvariantError"](`Expected a ${JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$app$2d$router$2d$headers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_REQUEST_ID_HEADER"])} response header.`), "__NEXT_ERROR_CODE", {
                value: "E807",
                enumerable: false,
                configurable: true
            });
...
async function fetchServerResponse(url, options) {
   ...
   */ if (prefetchKind === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$router$2d$reducer$2d$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PrefetchKind"].AUTO) {
    ...
    try {
        ...
        const response = await createFromNextReadableStream(flightStream, res.headers);
...
async function createFetch(url, headers, fetchPriority, signal) {
    ...
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    if (("TURBOPACK compile-time value", "development") !== 'production' && self.__next_r) {
...
function createFromNextReadableStream(flightStream, responseHeaders) {
...
function makeUntrackedSearchParamsWithDevWarnings(underlyingSearchParams, store) {
    ...
    const promise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$dynamic$2d$rendering$2d$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["makeDevtoolsIOAwarePromise"])(proxiedUnderlying);
    promise.then(()=>{
...
//# sourceMappingURL=node_modules_next_dist_cdd0ea54._.js.map