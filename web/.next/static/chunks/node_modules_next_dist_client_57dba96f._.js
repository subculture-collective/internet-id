...
const version = "15.6.0-canary.47";
window.next = {
    version,
    appDir: true
};
...
function createDebugChannel(responseHeaders) {
    let requestId;
    if (responseHeaders) {
        requestId = responseHeaders.get(_approuterheaders.NEXT_REQUEST_ID_HEADER) ?? undefined;
        if (!requestId) {
            throw Object.defineProperty(new _invarianterror.InvariantError(`Expected a ${JSON.stringify(_approuterheaders.NEXT_REQUEST_ID_HEADER)} response header.`), "__NEXT_ERROR_CODE", {
                value: "E807",
                enumerable: false,
                configurable: true
            });
...
function rescheduleLinkPrefetch(instance, priority) {
    ...
    if (typeof window !== 'undefined') {
        ...
        //TURBOPACK unreachable
        ;
        const getCurrentAppRouterState = undefined;
        ...
        case _hotreloadertypes.HMR_MESSAGE_SENT_TO_BROWSER.ISR_MANIFEST:
            {
                if ("TURBOPACK compile-time truthy", 1) {
                    ...
                    if (staticIndicatorState.pathname && staticIndicatorState.pathname in message.data) {
...
function navigateReducer(state, action) {
    ...
    return data.then(({ flightData, canonicalUrl: canonicalUrlOverride, postponed })=>{
    ...
    "TURBOPACK unreachable" : (href, options)=>{
        ...
        if (url !== null) {
            ...
            (0, _prefetchreducer.prefetchReducer)(actionQueue.state, {
                ...
                url,
                kind: options?.kind ?? _routerreducertypes.PrefetchKind.FULL
            });
        }
    },
...
//# sourceMappingURL=node_modules_next_dist_client_57dba96f._.js.map